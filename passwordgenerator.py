...
Font=('arial',15,'bold')
passwordLabel=Label(root,text="password generator",font=('times new roman',21,'bold'),bg="green",fg="white")
...
lengthLabel=Label(root,text="password length",font=Font,bg="green",fg="white")
...
passLabel=Label(root,text="display-box",font=Font,bg="green",fg="white")
